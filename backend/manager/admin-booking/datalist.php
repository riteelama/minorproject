                    ...
                    <!-- <div class="table-responsive"> -->
                        <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                            ...
                            <tr>
                                    ...
                                    <td><a href="?status=<?php echo $row['id']; ?>" style ="color:<?php echo $row['status']?'green' : 'red'; ?>"onclick="return confirm('Are you sure to change the status of this item?')"> <?php echo $row['status']?'Approved' : 'Not Approved';?></a>  </td>
                                    <td colspan="2">
