                        ...
                        <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                            ...
                            <thead>
                                ...
                                <tr role="row">
                                    ...
                                    <th name="excerpt">User Fullname</th>
                            ...
                            <tr>
                                    ...
                                    <td style ="color:<?php echo $row['status']?'green' : 'red'; ?>"onclick="return confirm('Are you sure to change the status of this item?')">><?php echo $row['status']?'Approved' : 'Not Approved';?></a>  </td>
                                    <td colspan="2">
