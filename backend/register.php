...
if(isset($_POST['create'])){
    ...
    if($password != $confirmpassword){
        ...
        $sql = "INSERT INTO users(fullname,username,email,password,phoneno,address,status,role_id) VALUES ('$fullname','$username','$email',md5('$password'),'$phoneno','$address','$status','$role_id')";
        // var_dump($sql);
